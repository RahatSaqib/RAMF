...
public class User extends AbstractEntity implements UserListItem {
    ...
    @Generated(hash = 854106425)
    public User(Long id, String entityID, Integer authenticationType, Date lastOnline, String typee) {
        this.id = id;
...
//        this.refresh();
    ...
    public void setType(String type) {
        setMetaString(Keys.Type, type);
    }

    public String getType() {
        return metaStringForKey(Keys.Type);
    }
