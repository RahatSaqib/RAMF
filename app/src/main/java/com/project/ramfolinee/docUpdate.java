...
import com.project.ramfolinee.Admin.AdminCategoryActivity;
...
public class docUpdate extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        productsRef = FirebaseDatabase.getInstance().getReference().child("UsersD").child(productID);
        ...
        productsRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                if (dataSnapshot.exists())
                {
                    ...
                    String pPrice = dataSnapshot.child("phone").getValue().toString();
                    String pDescription = dataSnapshot.child("type").getValue().toString();
