...
import com.project.ramfolinee.ViewHolder.ConvViewHolder;
...
public class ChatsFragment extends Fragment {
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<Conv, ConvViewHolder> adapter = new FirebaseRecyclerAdapter<Conv, ConvViewHolder>(options) {
            ...
            @Override
            protected void onBindViewHolder(@NonNull final ConvViewHolder holder, int i, @NonNull final Conv conv) {
                ...
                lastMessageQuery.addChildEventListener(new ChildEventListener() {
                    ...
                    public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                        DatabaseReference list= FirebaseDatabase.getInstance().getReference().child("UsersD").child(list_user_id);
                        ...
                        list.addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                String mes= dataSnapshot.child("name").getValue().toString();
                                if(data.startsWith("https://")){
                                    holder.setMessage(" Attached a photo", conv.isSeen());
                                }
                                else{
            ...
            public ConvViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                ...
                ConvViewHolder holder = new ConvViewHolder(view);
                return holder;
            }
        };
