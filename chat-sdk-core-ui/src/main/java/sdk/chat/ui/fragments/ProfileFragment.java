...
public class ProfileFragment extends BaseFragment {
    ...
    @BindView(R2.id.about) protected ImageView text;
    ...
    public void updateInterface() {
        ...
        if (isCurrentUser) {
            fab.setImageDrawable(Icons.get(getContext(), Icons.choose().edit, R.color.white));
            ...
            fab.setImageDrawable(Icons.get(getContext(), Icons.choose().chat, R.color.white));
            fab.setOnClickListener(v -> {
                startChat();
            });
